...
import com.xinran.studyindanke.recylerview_adapter_helper.adapter.AQuickAdapter;
...
public class BaseRecylerViewAdapterHelperAct extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private AQuickAdapter mAQuickAdapter;
    private View head0;
    ...
    private void initView() {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager
                .VERTICAL, false));
        mRecyclerView.setAdapter(mAQuickAdapter = new AQuickAdapter(mockData()));
