...
import com.xinran.studyindanke.recylerview_adapter_helper.adapter.DragerQuickAdapter;
...
public class DragerRecylerViewAdapterHelperAct extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private DragerQuickAdapter mAQuickAdapter;
    private View head0;
    ...
    private void initView() {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager
                .VERTICAL, false));
        mRecyclerView.setAdapter(mAQuickAdapter = new DragerQuickAdapter(mockData()));
    ...
    private void setSwipeDelete() {
        // 开启滑动删除
        mAQuickAdapter.enableSwipeItem();
        mAQuickAdapter.setOnItemSwipeListener(new OnItemSwipeListener() {
            //1  2... 3 2... 4
            @Override
            ...
            public void onItemSwipeMoving(Canvas canvas, RecyclerView.ViewHolder viewHolder, float dX, float dY, boolean isCurrentlyActive) {
                Log.e("Swipe2:","dx"+dX+"dy"+dY+"isCurrentlyActive"+isCurrentlyActive);//2
            }
        });

    }

    private void setDragerAbout() {
        ItemDragAndSwipeCallback itemDragAndSwipeCallback = new ItemDragAndSwipeCallback(mAQuickAdapter);
        ItemTouchHelper itemTouchHelper = new ItemTouchHelper(itemDragAndSwipeCallback);
        itemTouchHelper.attachToRecyclerView(mRecyclerView);

// 开启拖拽
        mAQuickAdapter.enableDragItem(itemTouchHelper, R.id.tv_name, true);
        mAQuickAdapter.setOnItemDragListener(new OnItemDragListener() {
            @Override
            ...
            public void onItemDragMoving(RecyclerView.ViewHolder source, int from, RecyclerView
                ...
                Log.e("dragger2:","from"+from+"to"+to);
            ...
            public void onUpFetch() {
                ...
                mRecyclerView.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        if(result==1){
                            mAQuickAdapter.setNewData(mockData());
                        }else if(result==2){
...
//        });
        mAQuickAdapter.setOnLoadMoreListener(new BaseQuickAdapter.RequestLoadMoreListener() {
            ...
            public void onLoadMoreRequested() {
               ...
               int result= random.nextInt(4);
                if(result==1){
                    mAQuickAdapter.addData(mockData());
