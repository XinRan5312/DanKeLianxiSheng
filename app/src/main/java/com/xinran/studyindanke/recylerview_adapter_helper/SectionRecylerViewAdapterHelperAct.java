...
import com.xinran.studyindanke.recylerview_adapter_helper.adapter.ASectionQuickAdapter;
...
public class SectionRecylerViewAdapterHelperAct extends AppCompatActivity {
    private RecyclerView mRecyclerView;
    private ASectionQuickAdapter mAQuickAdapter;
    private View head0;
    ...
    private void initView() {
        ...
        mRecyclerView.setLayoutManager(new LinearLayoutManager(this, LinearLayoutManager
                .VERTICAL, false));
        mRecyclerView.setAdapter(mAQuickAdapter = new ASectionQuickAdapter(mockSectionData()));
...
//        });
    ...
    private List<SectionBean> mockSectionData() {
        List<SectionBean> list = new ArrayList<>();
        SectionBean sectionBean=null;
        for (int i = 0; i < 15; i++) {
            if(i==0){
                sectionBean=new SectionBean(true,"第一Section");
            }else if(i==6){
                sectionBean=new SectionBean(true,"第二Section");
            }else if(i==11){
                sectionBean=new SectionBean(true,"第三Section");
            }else{
                Student stu = new Student("Jack" + i, i);
                sectionBean=new SectionBean(stu);
            }
